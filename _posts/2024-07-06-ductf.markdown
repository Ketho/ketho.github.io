...
This was my first CTF event with Hague Hackers. It is intended as an entry level CTF event for anyone to join. There were special categories for teams from Australian and New Zealand.
...
![](https://ketho.github.io/data/img/ductf_team.jpg)
...
![](https://ketho.github.io/data/img/20240706_ductf_emu.jpg)
